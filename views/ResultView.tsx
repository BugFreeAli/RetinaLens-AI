            ...
            <div className="relative lg:w-1/2 bg-slate-900 overflow-hidden group">
              ...
              {isPositive && (
                <div
                  ...
                  style={{
                    background:
                      'radial-gradient(circle at 40% 40%, rgba(255, 0, 0, 0.5) 0%, rgba(255, 100, 0, 0.3) 40%, transparent 70%)',
                  }}
                />
              )}
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <div className="flex items-center gap-2 mb-2">
                  <span className="relative flex h-3 w-3">
                    ...
                    <span className="relative inline-flex rounded-full h-3 w-3 bg-emerald-50" />
                  </span>
                ...
                <p className="text-white/70 text-sm max-w-[80%]">
                  Retinal fundus scan analyzed via NeuralOptic V4.2 Core.
                </p>
              </div>
            </div>
              ...
              <div className="flex flex-wrap items-start justify-between gap-4 border-b dark:border-white/10 pb-8">
                <div>
                  ...
                  <p className="text-slate-500 text-sm">
                    Generated on {DEMO_PATIENT.scanDate}
                  </p>
                </div>
              ...
              >
                ...
                >
                  <span className="material-symbols-outlined">
                    {isPositive ? 'warning' : 'verified_user'}
                  </span>
                </div>
              ...
              <div className="flex-grow">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-2">
                  {result.findings.map((f, i) => (
                    <div
                      key={i}
                      className="flex justify-between items-center py-3 border-b border-slate-100 dark:border-white/5"
                    >
                      <span className="text-slate-600 dark:text-slate-400 text-sm font-medium flex items-center gap-2">
                        <span
                          className={`size-1.5 rounded-full ${
                            isPositive ? 'bg-secondary' : 'bg-primary'
                          }`}
                        />
                        {f.label}
                      </span>
